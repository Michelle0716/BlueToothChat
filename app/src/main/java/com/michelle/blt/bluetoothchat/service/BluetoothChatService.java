...
package com.michelle.blt.bluetoothchat.service;
...
/**
 * 长时间不通信，会导致socket中断，需要隔断时间，传送数据
 * 通信socket,handle+thread+socket
 */
    ...
    class AcceptThread extends Thread{
        ...
        public AcceptThread(){
            ...
            try {
                   ...
                   // tmp = BlueToothConnectUtil.setSocket(d);
            }   catch (IOException e) {
                e.printStackTrace();
            }
            serverSocket = tmp;
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                mSocket = device.createRfcommSocketToServiceRecord(
                        MY_UUID_SECURE);
//                BlueToothConnectUtil e=new BlueToothConnectUtil();
//                mSocket=e.setSocket(device);
            } catch (Exception e) {
                e.printStackTrace();
